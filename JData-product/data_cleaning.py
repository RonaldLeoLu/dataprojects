...
os.chdir('D:/projects/JData-product')
...
def get_actions_02():
    action02 = pd.read_csv(action_02_path)
    return action02

def get_actions_03():
    action3_1 = pd.read_csv(action_03_path)
    action3_2 = pd.read_csv(action_03extra_path)
    action03 = pd.concat([action3_1,action3_2],axis=0,ignore_index=True)
    return action03

def get_actions_04():
    action04 = pd.read_csv(action_04_path)
    return action04
